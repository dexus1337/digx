...
<tileset version="1.9" tiledversion="1.9.2" name="digx-tiles" tilewidth="32" tileheight="32" tilecount="19" columns="0">
 ...
 <tile id="1">
  <image width="32" height="32" source="stone-1.png" />
 </tile>
 ...
 <tile id="4" type="soldier">
  <image width="32" height="32" source="soldier-front.png" />
 </tile>
 <tile id="5" type="vampire">
 ...
 <tile id="8" type="stone">
  <image width="32" height="32" source="stone-low.png" />
 </tile>
 <tile id="9" type="stone">
  <image width="32" height="32" source="stone-high.png" />
 </tile>
 <tile id="10" type="diamond">
  <image width="32" height="32" source="diamond-blue.png" />
 </tile>
 <tile id="11" type="gold_coin">
  <image width="32" height="32" source="coin.png" />
 </tile>
 <tile id="12" type="lamp">
  <image width="32" height="32" source="lamp.png" />
 </tile>
 <tile id="13" type="garlic">
  <image width="32" height="32" source="garlic.png" />
 </tile>
 <tile id="14" type="onion">
  <image width="32" height="32" source="onion.png" />
 </tile>
 <tile id="15" type="pickaxe">
  <image width="32" height="32" source="pickaxe.png" />
 </tile>
 <tile id="16" type="exit_door">
  <image width="32" height="32" source="door-closed.png" />
 </tile>
 <tile id="17" type="diamond_hidden">
  <image width="32" height="32" source="blink.png" />
 </tile>
